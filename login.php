...
include("connection.php");
	...
	/*$link = mysqli_connect("localhost","cl58-workdb","9xHV2-E7.","cl58-workdb"); */
	...
	if ($_POST['submit']=="Sign Up"){
		...
		if ($error) $error="There were error(s) in your sign up details:".$error;
			...
			if($results) $error="That email address is already registered.Do you want to log in?";
				...
				//hashing of email address combining that password by hashing
	...
	if ($_POST['submit']=="Log In"){
		...
		if($row){
			...
			$error= "We couldnot find a user with that email and password. please try again.";
		}
	}
